...
<hr>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" v-model="form.date_of_last_menstrual_period" @change="getProbableDate" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" v-model="form.probable_date_of_delivery" readonly required>
                    </div>
                </div>
